...
<body>
<br>
<DIV class="w3-panel w3-border-right w3-border-left w3-border-green" style="width:30%; max-width:200px; margin:0 auto; font-size: x-large; text-align: center;">글 목록</DIV>
<br><br>

<div style=" width:60%; margin: 0 auto;"> 
<button class="w3-button w3-border w3-padding-small w3-hover-teal w3-block" type="button"  onclick="location.href='create'">글 쓰기</button>
